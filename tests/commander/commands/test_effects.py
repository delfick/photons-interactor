...
from photons_themes.addon import default_colors as theme_default_colors
...
@pytest.fixture()
def default_colors():
    return [mock.ANY for c in theme_default_colors]


@pytest.fixture()
def effects_running_status(default_colors):
    return {
        "results": {
            "d073d5000001": {
                "effect": {"type": "SKIP"},
...
describe "Effect commands":
    ...
    async it "works if devices are offline", fake, runner, asserter, results:
